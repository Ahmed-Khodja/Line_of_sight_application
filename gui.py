...
layout = [
    ...
    [sg.Text('VHF:    '), sg.Combo(['Alger','ElOued', 'HassiMessaoud','Illizi','InAminas', 'Bousaada','Biskra','ElGoléa','Ghardaia','Adrar','BordjBadjiMokhtar','Chenachene','HassiKhebi','InSalah','Timimoune','Tindouf','Djanet','InGuezzam','Tamnrasset','Béchar','ElBayadh','Mascara','Oran','Annaba','Constantine','Sétif'], key='VHF', default_value='')],
